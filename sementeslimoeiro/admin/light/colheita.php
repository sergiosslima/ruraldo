...
<body class="theme-indigo">
    <div class="page-loader-wrapper">
        <div class="loader">
            <div class="m-t-30"><img src="../assets/images/brand/ruraldo.svg" width="120" height="120" alt="Ruraldo" title="Ruraldo"></div>
            <p>Só um minutin ...</p>
        </div>
    </div>
    <nav class="navbar custom-navbar navbar-expand-lg py-2">
        <div class="container-fluid px-0">
            ...
            <a href="colheita.html" class="navbar-brand"><img src="../assets/images/brand/ruraldo.svg" alt="Ruraldo" title="Ruraldo" />
                <strong>Ruraldo</strong></a>
            <div id="navbar_main">
    ...
    <div class="main_content" id="main-content">
        <div class="left_sidebar">
            <nav class="sidebar">
                <div class="user-info">
                    <div class="image"><a href="javascript:void(0);"><img src="../assets/images/logo.png" alt="Sementes Limoeiro" title="Sementes Limoeiro"></a></div>
                    <div class="detail mt-3">
                        <h5 class="mb-0">Sementes Limoeiro</h5>
                    </div>
                </div>
                <ul id="main-menu" class="metismenu">
                    <li class="active">
                        ...
                        <ul>
                            <li class="active"><a href="colheita.html">Colheita</a></li>
                            <li><a href="beneficiamento.html">Beneficiamento</a></li>
                        </ul>
                    </li>
                </ul>
            </nav>
            ...
            <div class="container-fluid">
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="header">
                                <h2><strong>SOJA</strong> – Colheita</h2>
                            </div>
                            <div class="body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                        <thead>
                                            <tr>
                                                <th>Gleba</th>
                                                <th width="1">Área&nbsp;(ha)</th>
                                                <th>Cultivar</th>
                                                <th width="1">Categoria</th>
                                                <th width="1">Data</th>
                                                <th width="1">Bruto&nbsp;(kg)</th>
                                                <th width="1">Tara&nbsp;(kg)</th>
                                                <th width="1">Líquido&nbsp;(kg)</th>
                                                <th width="1">Umidade&nbsp;(%)</th>
                                                <th>Motorista</th>
                                                <th width="1">Placa</th>
                                                <th>Destino</th>
                                            </tr>
